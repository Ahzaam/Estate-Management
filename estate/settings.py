...
ALLOWED_HOSTS = ['clglide.azurewebsites.net', 'estatemanagements.herokuapp.com', '127.0.0.1']
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'glide.ceylon@gmail.com'
EMAIL_HOST_PASSWORD = 'lastzchjbzicjchr'
